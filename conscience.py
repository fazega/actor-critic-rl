...
class Conscience:
    def __init__(self):
        ...
        self.layer2 = tf.layers.dense(self.layer1, units=100, activation=tf.nn.leaky_relu)
        self.layer3 = tf.layers.dense(self.layer2, units=50, activation=tf.nn.softplus)
        self.layer4 = tf.layers.dense(self.layer3, units=30, activation=tf.nn.softplus)
